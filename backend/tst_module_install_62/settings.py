"""
Django settings for tst_module_install_62 project.
...
ROOT_URLCONF = 'tst_module_install_62.urls'
...
WSGI_APPLICATION = 'tst_module_install_62.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_module_install_62 API",
    "DESCRIPTION": "API documentation for tst_module_install_62 App",
    "VERSION": "v1",
}
