...
## Project Structure
    ...
    ├── tst_module_install_62  # Django project configurations
...
1. Clone this repo and `cd tst_module_install_62`
...
2. Clone this repo and `cd tst_module_install_62`
